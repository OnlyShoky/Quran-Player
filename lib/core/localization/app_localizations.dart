...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'section_support': 'Support sukun',
      'support_paypal': 'Support via PayPal',
      'buy_me_a_coffee': 'Buy Me a Coffee',
      'donation_link_error': 'Unable to open the support link.',
      'version': 'Version',
      'filters': 'Filters',
      'filter_juz': 'Juz',
      'filter_hizb': 'Hizb',
      ...
      'section_audio_sources': 'Audio Sources & APIs',
      'audio_sources_desc': 'Choose which APIs provide audio. Reciters are automatically merged and deduplicated.',
      'api_mp3quran_desc': 'Extensive catalog with multiple riwayat and high quality servers.',
    ...
    'es': {
      ...
      'app_description':
        ...
        'section_support': 'Apoya sukun',
        'support_paypal': 'Apoyar con PayPal',
        'buy_me_a_coffee': 'Invítame a un café',
        'donation_link_error': 'No se pudo abrir el enlace de apoyo.',
      'version': 'Versión',
      'filters': 'Filtros',
      'filter_juz': 'Juz',
      'filter_hizb': 'Hizb',
      ...
      'section_audio_sources': 'Fuentes de Audio y APIs',
      'audio_sources_desc': 'Elige qué APIs proporcionan audio. Los recitadores se fusionan y deduplican automáticamente.',
      'api_mp3quran_desc': 'Catálogo extenso con múltiples riwayat y servidores de alta calidad.',
    ...
    'fr': {
      ...
      'section_support': 'Soutenir sukun',
      'support_paypal': 'Soutenir avec PayPal',
      'buy_me_a_coffee': 'Offrir un café',
      'donation_link_error': 'Impossible d’ouvrir le lien de soutien.',
      'version': 'Version',
      'filters': 'Filtres',
      'filter_juz': 'Juz',
      'filter_hizb': 'Hizb',
      ...
      'section_audio_sources': 'Sources audio et API',
      'audio_sources_desc': 'Choisissez quelles API fournissent l\'audio. Les récitateurs sont fusionnés et dédupliqués automatiquement.',
      'api_mp3quran_desc': 'Vaste catalogue avec plusieurs lectures et serveurs haute fidélité.',
    ...
    'ar': {
      ...
      'contribute': 'ساهم',
      'section_support': 'ادعم sukun',
      'support_paypal': 'الدعم عبر PayPal',
      'buy_me_a_coffee': 'اشترِ لي قهوة',
      'donation_link_error': 'تعذر فتح رابط الدعم.',
      'version': 'الإصدار',
      'filters': 'التصفية',
      'filter_juz': 'الجزء',
      'filter_hizb': 'الحزب',
      ...
      'section_audio_sources': 'مصادر الصوت وواجهات البرمجة',
      'audio_sources_desc': 'اختر الخوادم والمصادر الصوتية. يتم دمج القراء وإزالة التكرار تلقائياً.',
      'api_mp3quran_desc': 'مكتبة شاملة بروايات متعددة وسيرفرات عالية الجودة.',
